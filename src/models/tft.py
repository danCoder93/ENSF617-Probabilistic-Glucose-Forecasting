...
class MaybeLayerNorm(LightningModule):
...
class VariableSelectionNetwork(LightningModule):
...
class StaticCovariateEncoder(LightningModule):
    def __init__(self, config):
        super().__init__()
...
class InterpretableMultiHeadAttention(LightningModule):
    def __init__(self, config):
        super().__init__()
